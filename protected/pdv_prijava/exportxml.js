...
document.getElementById('xmlButton').addEventListener(
  ...
  function () {
    ...
    // Provjeri da li je označena izmenjena prijava
    const izmenjenaCheckbox = document.getElementById('izmenjena_prijava');
    const izmijenjenaPrijava =
      izmenjenaCheckbox && izmenjenaCheckbox.checked ? 'true' : 'false';
  ...
  <Godina>2025</Godina>
  <IzmijenjenaMjesecnaPrijava>${izmijenjenaPrijava}</IzmijenjenaMjesecnaPrijava>
  <Naziv>${naziv}</Naziv>
  <SifraDjelatnosti/>
